"""
Test Module: Update Control Permission
=====================================
Checks if a user with the proper role can update a control in Clarity LIMS.
...
def test_update_control(page, expected=True):
    """
    Checks if role can update a control in Clarity LIMS.
    Accepts a Playwright 'page' object from the test framework.
    Returns structured JSON result.
    """
    print("\n===== TEST: Update Control Permission =====")
    print(f"Project: {PROJECT_NAME}")

    result = {
        "test_name": "Update Control",
        "description": "Checks if role can update a control in Clarity LIMS",
        "execution_time": 0.0,
        "expected": expected,
        "passed": False,
        "result": "fail",
    ...
    for attempt in range(1, max_attempts + 1):
        try:
            ...
            print("Filling out 'Supplier' field...")
            ...
            result["screenshot"], _ = capture_screenshot(page, "update_control", "pass")
            ...
            result["screenshot"], _ = capture_screenshot(page, "update_control", "fail")
