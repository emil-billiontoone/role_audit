"""
Test Module: Delete Reagent Kit Permission
=====================================
Checks if a user with the proper role can delete a reagent kit in Clarity LIMS.
...
def test_delete_reagent_kit(page, expected=True):
    """
    Checks if role can delete a reagent kit in Clarity LIMS.
    ...
    result = {
        "test_name": "Delete Reagent Kit",
        "description": "Checks if role can delete a reagent kit in Clarity LIMS",
        "execution_time": 0.0,
        "expected": expected,
        "passed": False,
        "result": "fail",
