...
def test_permissions_move_to_next_step(page):
    ...
    result = {
        "test_name": "Move To Next Step Permission",
        "description": "Checks if user can move to the next step in Clarity LIMS",
        "execution_time": 0.0,
        "expected": True,
        "passed": False,
        "result": "fail",
    ...
    try:
        ...
        step_button = page.locator("div.sub-work:has-text('Step 1 » Aneuploidy - Plasma Isolation')")
        ...
        screenshot_file = f"screenshots/move_to_next_step_{timestamp}.png"
        try:
